...
const Signup = (props) => {
    ...
    const { addUser, clear, clearResponse } = boxActions || {};
    ...
    return (<>
        ...
        <ModalBox style={{ background: '#282a35' }}>
            ...
            <div className="signup-inputbox">
                ...
                {list && list?.map((e, i) => {
                    ...
                    return (
                        <>
                            <div key={i}>
                                <label>{e?.label}</label>
                                <input type="text" className="signup-input" name={e?.name} placeholder={e?.placeholder} onChange={(e) => handleChange(e, i)} />
                                {e?.error && <p>{e?.error}</p>}
                            </div>
                ...
                <div>
                    <a className="signup-link">sign in? click here</a>
                </div>
